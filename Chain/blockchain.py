...
def create_new_block(previous_block, transactions: List[Dict[str, int]]):
    ...
    current_block_hash = calculate_hash(str(index) + previous_hash + str(timestamp) + str(validator_signatures) + str(consensus_round))
