...
class Blockchain:
    ...
    def create_new_block(self, previous_block, new_block_data):
        ...
        elif previous_block.data == new_block_data or previous_hash == current_block_hash:
            return None
        else:
            return Block(
                index=index,
    ...
    def add_block(self, new_block_data):
        ...
        print("[NEW_BLOCK_DATA]", new_block_data)
        new_block = self.create_new_block(previous_block, new_block_data)
        if new_block != None:
            print("new_block is not None! the result is:", new_block)
